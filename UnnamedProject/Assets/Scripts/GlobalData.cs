...
public class GlobalData : MonoBehaviour
{
	...
	void Start()
	{
		...
		getTexureById.Add(100, Resources.Load("Textures/ObjectsTextures/100") as Texture2D);
		getTexureById.Add(101, Resources.Load("Textures/ObjectsTextures/101") as Texture2D);
		getTexureById.Add(102, Resources.Load("Textures/ObjectsTextures/102") as Texture2D);
		//texture_by_id.Add(13, Resources.Load("Textures/EnemyAnimationFrame/RatAnimationFrame(13)/Rat1") as Texture2D);
		getTexureById.Add(103, Resources.Load("Textures/ObjectsTextures/103") as Texture2D);
		getTexureById.Add(104, Resources.Load("Textures/ObjectsTextures/104") as Texture2D);
		getTexureById.Add(105, Resources.Load("Textures/ObjectsTextures/105") as Texture2D);
		getTexureById.Add(106, Resources.Load("Textures/ObjectsTextures/106") as Texture2D);
		getTexureById.Add(0, Resources.Load("Textures/ObjectsTextures/0") as Texture2D);
	}
